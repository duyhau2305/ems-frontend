 ...
 return (
   <div className="relative z-50" ref={dropdownRef}>
     ...
     >
       ...
       {darkMode ? <span data-translate="darkmode">Dark Mode</span> : <span data-translate="lightmode">Light Mode</span>}
     </button>
     {isOpen && (
       <div className="absolute mt-2 right-0 ml-2 w-[132px] bg-white dark:bg-[#0D2743] border border-gray-200 dark:border-gray-600 rounded-lg shadow-lg z-10">
         <ul>
           <li
